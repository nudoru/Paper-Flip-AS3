/*
	...
	Edits by Matt Perkins (kheavy@nudoru.com) on 3.2.10
		updated to PV3d 2
		added curl getter/setter for animation of the page with tween engines
*/
...
package com.zeropointnine {
	...
	public class CurlingPlane extends TriangleMesh3D {
		...
		private var segmentsW:int = 10;		// DEFAULT was 5, upped to improve quality
		...
		// for easier tweening
		public function set curl($v:Number):void {
			currentRotation = $v;
			rotate(currentRotation);
		}
		
		public function get curl():Number { return currentRotation; }
